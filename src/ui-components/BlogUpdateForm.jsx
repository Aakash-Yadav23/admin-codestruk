...
export default function BlogUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setTableOfContents(
      typeof cleanValues.tableOfContents === "string" ||
        cleanValues.tableOfContents === null
        ? cleanValues.tableOfContents
        : JSON.stringify(cleanValues.tableOfContents)
    );
    setSeoTitle(cleanValues.seoTitle);
    setSeoDescription(cleanValues.seoDescription);
    setSeoKeywords(cleanValues.seoKeywords);
    setViews(cleanValues.views);
    setCategoryId(cleanValues.categoryId);
    setFeaturedId(cleanValues.featuredId);
