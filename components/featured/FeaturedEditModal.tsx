// components/featured/FeaturedEditModal.tsx
...
type Props = {
  ...
  onUpdate: (updatedData: Featured) => void;
};
...
export function FeaturedEditModal({
  ...
  const [formData, setFormData] = useState<Featured>(featured);
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the featured item details below.
          </DialogDescription>
        </DialogHeader>
